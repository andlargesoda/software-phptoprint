...
В таблице ниже приведен перечень формализированных требований к разрабатываемому программному обеспечению.
...
![Изображение](05_11_ИР_UseCase_v1.1.1.drawio_5.png "Диаграмма вариантов использования")
